...
public boolean changePassword(String npw) {
	try {
		pstmt=con.prepareStatement("UPDATE BANKAPPLICATION SET PASSWORD=? WHERE ACCOUNT_NUMBER=? AND PASSWORD=?");
...
return al;
   ...
   public boolean resetPassword() {
		try {
			pstmt=con.prepareStatement("UPDATE BANKAPPLICATION SET PASSWORD=? WHERE EMAIL=?");
